...
public class TelluriaBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<TelluriaSignBlockEntity>> SIGN_BLOCK_ENTITIES = BLOCK_ENTITIES
            .register("sign_block_entity", () -> BlockEntityType.Builder.of(TelluriaSignBlockEntity::new,
                    TelluriaBlocks.WILLOW_WALL_SIGN.get(),
                    TelluriaBlocks.WILLOW_SIGN.get()).build(null));
